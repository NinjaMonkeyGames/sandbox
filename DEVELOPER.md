# Markdownlint-cli2-CI Workflow Docker Container
...
![GitHub Pre-Release](https://img.shields.io/github/v/release/ninjamonkeygames/full-stack-development-template?include_prereleases)

---

## Table of Contents

- [Markdownlint-cli2-CI Workflow Docker Container](#markdownlint-cli2-ci-workflow-docker-container)
  ...
  - [Project Assets](#project-assets)
    ...
    - [CHECK COMMIT SIGNATURE \[ESLINT.CONFIG.JS\] 📄](#check-commit-signature-eslintconfigjs-)
...
[Back to top](#markdownlint-cli2-ci-workflow-docker-container)
...
### CHECK COMMIT SIGNATURE [ESLINT.CONFIG.JS] 📄
...
Enforce best practises when working with JS files.

#### Asset Contents Description — [eslint.config.js]

Configuration for linting JS, JSDOC, TS, JSON, JSONC files with ESLint.

🚨 **ESLint has issues with `eslint.config.js` being stored outside of the root folder so a symbolic link must be used
